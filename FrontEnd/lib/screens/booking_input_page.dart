...
//     return widget.roomOptions.fold(0.0, (sum, room) => sum + room.price) *
//         _calculateNights() *
...
//                                   ),
//                                   const SizedBox(height: 16),
//                                   ...widget.roomOptions.map((room) => Padding(
//                                         padding:
...
//                                   _buildDetailItem('Nhận phòng',
//                                       'T6, 18 tháng 7 2025', '14:00 – 23:00'),
//                                   _buildDetailItem('Trả phòng',
//                                       'T7, 19 tháng 7 2025', '08:00 – 12:00'),
//                                   const SizedBox(height: 8),
//                                   Text('Chỉ còn $daysRemaining ngày nữa!',
//                                       style: TextStyle(
//                                           fontSize: 14,
//                                           color: Colors.red[700],
//                                           fontWeight: FontWeight.bold)),
//                                   _buildDetailItem('Tổng thời gian lưu trú', '',
//                                       '${_calculateNights()} đêm'),
//                                   const SizedBox(height: 16),
//                                   Text('Tóm Tắt Giá',
//                                       style: TextStyle(
//                                           fontSize: 20,
...
//                                       isBold: true),
//                                   _buildSummaryItem('Thuế (10%)',
//                                       '${_calculateTax().toStringAsFixed(0)} VND'),
//                                 ],
//                               ),
//                             ),
//                           ),
