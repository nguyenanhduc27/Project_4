...
//     final daysRemaining = 5; // hardcoded hoặc truyền từ trước
...
//                         SizedBox(
//                           width: 320,
//                           child: _buildRoomInfo(daysRemaining),
//                         ),
...
//   Widget _buildRoomInfo(int daysRemaining) {
//     return Card(
...
//             _buildDetailItem(
//                 'Nhận phòng', 'T6, 18 tháng 7 2025', '14:00 – 23:00'),
//             _buildDetailItem(
//                 'Trả phòng', 'T7, 19 tháng 7 2025', '08:00 – 12:00'),
//             const SizedBox(height: 8),
...
//                     fontWeight: FontWeight.bold)),
//             _buildDetailItem(
//                 'Tổng thời gian lưu trú', '', '${_calculateNights()} đêm'),
//             const SizedBox(height: 16),
//             Text('Tóm Tắt Giá',
//                 style: TextStyle(
//                     fontSize: 20,
...
//                     const SnackBar(content: Text('Thanh toán qua VNPay...')),
//                   );
//                 },
